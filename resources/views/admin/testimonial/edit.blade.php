...
@section('content')
    ...
    <form action="{{ route('admin.testimonials.update',$testimonial->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 ml-4">
            ...
            <textarea name="comment_en" class="form-control">{{ $testimonial->comment_en }}</textarea>
        </div>
        <div class="mb-3 ml-4">
            <label>Arbic Comment</label>
            <textarea name="comment_ar" class="form-control">{{ $testimonial->comment_ar }}</textarea>
        </div>
        <div class="mb-3 ml-4">
