              ...
              <div class="col-sm-6">
                ...
                <div class="footer-links">
                  ...
                  <p>
                    ...
                    United States <br>
                    <strong>Phone:</strong> +970 597 249398<br>
                    <strong>Email:</strong> taif@taifjamal08.com<br>
                  </p>
                </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="form">
              ...
              <form action="{{ route('site.contact') }}" method="post" role="form" >
                ...
                <div class="form-group mt-3">
                  <textarea class="form-control mb-3 @error('message') is-invalid @enderror " name="message" rows="5" placeholder="Message" >{{ old('message') }}</textarea>
                  @error('message')
                  <div class="invalid-feedback">{{ $message  }}</div>
                  @enderror
                </div>

                <div class="text-center"><button type="submit" title="Send Message" id="contact">Send Message</button></div>
              </form>
