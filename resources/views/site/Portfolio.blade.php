...
<section id="portfolio" class="portfolio section-bg">
  <div class="container" data-aos="fade-up">
    ...
    <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-{{ $detail->PortfolioCategry->$name }}">
            <div class="portfolio-wrap">
              <img src="{{asset('image/detaileImages/'.$detail->PortfolioDetaileImages->first()->path )}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><a href="{{ route('site.portfolio-details', ['categry'=> $detail->PortfolioCategry->$name , 'id'=>$detail->id]) }}">{{ $detail->$name }}</a></h4>
                <p>{{ $detail->PortfolioCategry->$name }}</p>
                <div>
                  <a href="{{asset('image/detaileImages/'.$detail->PortfolioDetaileImages->first()->path )}}" data-gallery="portfolioGallery" title="{{ $detail->$name }}" class="link-preview portfolio-lightbox"><i class="bi bi-plus"></i></a>
                  <a href="{{ route('site.portfolio-details' ,['categry'=> $detail->PortfolioCategry->$name , 'id'=>$detail->id]) }}" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
                </div>
              </div>
            </div>
        </div>
